...
const int output12 = 23;
const int output13 = 22;
...
void loop(){
  ...
  if (client) {                             // If a new client connects,
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Arthect<p>(Automated Real Time Household Electric Current Terminator)</p></h1>");
            
           
            
            
            // Display current state, and ON/OFF buttons for GPIO 12  
            client.println("<p>OUTLET #1 - State " + output12State + "</p>");
            ...
            client.println("<p>OUTLET 2 - State " + output27State + "</p>");
    ...
    // Display current state, and ON/OFF buttons for GPIO 13 
            client.println("<p>OUTLET 3 - State " + output13State + "</p>");
    ...
    // Display current state, and ON/OFF buttons for GPIO 14  
            client.println("<p>OUTLET 4 - State " + output14State + "</p>");
